...
#ifndef FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_MULTIPLE_SURFACES_IMPELLER_H_
#define FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_MULTIPLE_SURFACES_IMPELLER_H_
...
class AndroidMultipleSurfacesImpeller : public AndroidSurface {
 public:
  explicit AndroidMultipleSurfacesImpeller(std::shared_ptr<AndroidSurfaceFactory> surface_factory);

  ~AndroidMultipleSurfacesImpeller() override;
...
//   std::shared_ptr<PlatformViewAndroidJNI> jni_facade_;
  ...
  FML_DISALLOW_COPY_AND_ASSIGN(AndroidMultipleSurfacesImpeller);
};

}  // namespace flutter

#endif  // FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_MULTIPLE_SURFACES_IMPELLER_H_
